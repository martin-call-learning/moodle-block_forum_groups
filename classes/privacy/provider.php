...
/**
 * File containing the class implementing moodle's privacy API for the forum groups block.
 *
 ...
 */
namespace block_forum_groups\privacy;

use core_privacy\local\metadata\null_provider;

/**
 * Class implementing moodle's privacy API for the forum groups block.
 *
 * @package     block_forum_groups
 * @copyright   2023 Laurent David <laurent@call-learning.fr>
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
